...
- [ ] Explain what a token is used for.
    ...
    A token is used for authetication purposes to make sure you are who you say you are in a sense. The do expire and setting them to either expire or not can be done through the server like facebook, twitter, and LinkedIn have set up. 

- [ ] What steps can you take in your web apps to keep your data secure?

    Use of private routes can redirect anyone who has not logged in to the login screen if they try to access a page that you have to have a token to see. 

- [ ] Describe how web servers work.

    Web servers work by gathering the IP address from the domain name, requests the full URL, then displays the webpage on the browser of the user who requested to visit the website.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

  Put, post, and Get can be mapped to the CRUD acronym when interfacing with APIs and/or servers.
